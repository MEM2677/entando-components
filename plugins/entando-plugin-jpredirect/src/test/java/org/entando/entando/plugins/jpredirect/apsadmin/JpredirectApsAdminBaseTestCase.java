...
public class JpredirectApsAdminBaseTestCase extends ApsAdminBaseTestCase {
    ...
    private static final String CUSTOM_STRUTS_PLUGIN = "change_me-jpredirect-struts-plugin.xml";
}
